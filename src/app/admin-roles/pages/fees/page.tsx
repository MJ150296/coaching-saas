...
export default async function Page() {
  const { chartData } = await analytics.getFeesOverview({ months: 12 });

  return (
    <div className="p-8 min-h-screen bg-linear-to-br from-slate-50 via-indigo-50/40 to-sky-50/50">
      <h1 className="text-2xl font-semibold">Fees Analytics</h1>
      <p className="mt-2 text-sm text-gray-600">Overview of fees collections (mock data). Wire to DB for real data.</p>
