...
type OrganizationAdminDashboardClientProps = {
...
export default function OrganizationAdminDashboardClient({
  initialStats,
  initialRecentUsers,
}: OrganizationAdminDashboardClientProps) {
  ...
  return (
    <div className="bg-linear-to-br from-slate-50 via-cyan-50/30 to-blue-50/50 py-8">
      <div className="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <section className="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-5">
          <StatCard title="Total Coaching Centers" value={stats.totalCoachingCenters ?? 0} loading={loading} tone="blue" />
